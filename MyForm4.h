...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(452, 148);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(180, 36);
			this->label1->TabIndex = 12;
			this->label1->Text = L"Нужна баня\?";
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Location = System::Drawing::Point(354, 187);
			...
			this->radioButton2->CheckedChanged += gcnew System::EventHandler(this, &MyForm4::radioButton2_CheckedChanged);
			// 
			// radioButton1
			// 
			...
			this->radioButton1->Size = System::Drawing::Size(62, 37);
			this->radioButton1->TabIndex = 0;
			this->radioButton1->TabStop = true;
			this->radioButton1->Text = L"Да";
			this->radioButton1->UseVisualStyleBackColor = true;
			this->radioButton1->CheckedChanged += gcnew System::EventHandler(this, &MyForm4::radioButton1_CheckedChanged);
			// 
			// pictureBox1
			// 
